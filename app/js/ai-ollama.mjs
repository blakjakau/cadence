...
class Ollama extends AI {
	...
	async _queryModelCapability() {
        ...
        try {
			...
			let modelCaps;
			try {
				modelCaps = await response.json();
			} catch (e) {
				console.error("Failed to parse Ollama model capabilities as JSON", e);
    ...
    async _checkApiVersion() {
        ...
        try {
            ...
            try {
                ...
                console.warn("Failed to parse Ollama version response as JSON", e);
                this.ollamaVersion = null;
                return;
            }
